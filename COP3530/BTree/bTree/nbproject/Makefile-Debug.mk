...
${OBJECTDIR}/bTreeNode.o: bTreeNode.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/bTreeNode.o bTreeNode.cpp

${OBJECTDIR}/bTree_main.o: bTree_main.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/bTree_main.o bTree_main.cpp
